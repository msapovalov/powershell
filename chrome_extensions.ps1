...
$pathf = ls $env:LOCALAPPDATA\Google\Chrome *Extensions* -Recurse -Directory
#$extension_folders = (ls $env:LOCALAPPDATA\Google\Chrome *Extensions* -Recurse -Directory).DirectoryName
$extension_folders = Get-ChildItem -Path $pathf.
